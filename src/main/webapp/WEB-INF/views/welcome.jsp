    ...
    <div class="container">
      ...
      <div class="blueBannerHeading">
        <h1 class="blueBannerTitleWithSubtitle">
          <a style="color: #ffffff">Oracle Container Cloud Service + Wercker (Steps - hard luck)</a>
        </h1>
      </div>
  ...
  <div class="container serviceContainer" style="margin-top: 150px;">
    <div class="overviewLayout">
      <div>
              ...
              <br>
              <span style="color: #009; text-decoration: none">This is due to code push auto build by pradeep</span>
              <br>
              <p>
